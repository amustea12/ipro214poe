...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultLightDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultLightDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultLightDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultLightDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultLightDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultLightDto);
    });
