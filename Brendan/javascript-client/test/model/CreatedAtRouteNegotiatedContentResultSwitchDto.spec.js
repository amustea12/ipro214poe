...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultSwitchDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultSwitchDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultSwitchDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultSwitchDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultSwitchDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultSwitchDto);
    });
