...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.DeviceNodeDto();
  });
  ...
  describe('DeviceNodeDto', function() {
    it('should create an instance of DeviceNodeDto', function() {
      // uncomment below and update the code to test DeviceNodeDto
      //var instane = new GatewaySoftwareApi.DeviceNodeDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.DeviceNodeDto);
    });
