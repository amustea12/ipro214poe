...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultScheduleDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultScheduleDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultScheduleDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultScheduleDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultScheduleDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultScheduleDto);
    });
