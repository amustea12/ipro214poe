...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.ActivePolicyValueDto();
  });
  ...
  describe('ActivePolicyValueDto', function() {
    it('should create an instance of ActivePolicyValueDto', function() {
      // uncomment below and update the code to test ActivePolicyValueDto
      //var instane = new GatewaySoftwareApi.ActivePolicyValueDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.ActivePolicyValueDto);
    });
