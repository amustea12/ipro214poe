...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultApplicationKeyDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultApplicationKeyDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultApplicationKeyDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultApplicationKeyDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultApplicationKeyDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultApplicationKeyDto);
    });
