...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultNodeDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultNodeDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultNodeDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultNodeDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultNodeDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultNodeDto);
    });
