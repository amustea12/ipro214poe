...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.BatchLightingDto();
  });
  ...
  describe('BatchLightingDto', function() {
    it('should create an instance of BatchLightingDto', function() {
      // uncomment below and update the code to test BatchLightingDto
      //var instane = new GatewaySoftwareApi.BatchLightingDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.BatchLightingDto);
    });
