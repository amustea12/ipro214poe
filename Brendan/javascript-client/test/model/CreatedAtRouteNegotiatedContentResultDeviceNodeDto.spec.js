...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultDeviceNodeDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultDeviceNodeDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultDeviceNodeDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultDeviceNodeDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultDeviceNodeDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultDeviceNodeDto);
    });
