...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultZoneDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultZoneDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultZoneDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultZoneDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultZoneDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultZoneDto);
    });
