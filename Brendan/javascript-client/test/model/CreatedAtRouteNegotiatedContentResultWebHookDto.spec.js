...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultWebHookDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultWebHookDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultWebHookDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultWebHookDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultWebHookDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultWebHookDto);
    });
