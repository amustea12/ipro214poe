...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultTemperatureSensorDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultTemperatureSensorDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultTemperatureSensorDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultTemperatureSensorDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultTemperatureSensorDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultTemperatureSensorDto);
    });
