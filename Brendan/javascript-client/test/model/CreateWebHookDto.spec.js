...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreateWebHookDto();
  });
  ...
  describe('CreateWebHookDto', function() {
    it('should create an instance of CreateWebHookDto', function() {
      // uncomment below and update the code to test CreateWebHookDto
      //var instane = new GatewaySoftwareApi.CreateWebHookDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreateWebHookDto);
    });
