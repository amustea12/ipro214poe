...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultActionDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultActionDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultActionDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultActionDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultActionDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultActionDto);
    });
