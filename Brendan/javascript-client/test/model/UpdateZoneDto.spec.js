...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.UpdateZoneDto();
  });
  ...
  describe('UpdateZoneDto', function() {
    it('should create an instance of UpdateZoneDto', function() {
      // uncomment below and update the code to test UpdateZoneDto
      //var instane = new GatewaySoftwareApi.UpdateZoneDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.UpdateZoneDto);
    });
