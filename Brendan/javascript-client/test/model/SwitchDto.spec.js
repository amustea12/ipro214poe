...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.SwitchDto();
  });
  ...
  describe('SwitchDto', function() {
    it('should create an instance of SwitchDto', function() {
      // uncomment below and update the code to test SwitchDto
      //var instane = new GatewaySoftwareApi.SwitchDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.SwitchDto);
    });
