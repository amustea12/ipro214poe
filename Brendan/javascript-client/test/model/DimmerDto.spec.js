...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.DimmerDto();
  });
  ...
  describe('DimmerDto', function() {
    it('should create an instance of DimmerDto', function() {
      // uncomment below and update the code to test DimmerDto
      //var instane = new GatewaySoftwareApi.DimmerDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.DimmerDto);
    });
