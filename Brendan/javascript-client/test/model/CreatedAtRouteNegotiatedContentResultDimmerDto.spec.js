...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultDimmerDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultDimmerDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultDimmerDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultDimmerDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultDimmerDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultDimmerDto);
    });
