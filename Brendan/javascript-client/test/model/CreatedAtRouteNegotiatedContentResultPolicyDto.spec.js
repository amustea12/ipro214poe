...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultPolicyDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultPolicyDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultPolicyDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultPolicyDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultPolicyDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultPolicyDto);
    });
