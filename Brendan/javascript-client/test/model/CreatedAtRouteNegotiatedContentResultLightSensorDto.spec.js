...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultLightSensorDto();
  });
  ...
  describe('CreatedAtRouteNegotiatedContentResultLightSensorDto', function() {
    it('should create an instance of CreatedAtRouteNegotiatedContentResultLightSensorDto', function() {
      // uncomment below and update the code to test CreatedAtRouteNegotiatedContentResultLightSensorDto
      //var instane = new GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultLightSensorDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.CreatedAtRouteNegotiatedContentResultLightSensorDto);
    });
