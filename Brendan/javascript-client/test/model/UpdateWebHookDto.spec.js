...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.UpdateWebHookDto();
  });
  ...
  describe('UpdateWebHookDto', function() {
    it('should create an instance of UpdateWebHookDto', function() {
      // uncomment below and update the code to test UpdateWebHookDto
      //var instane = new GatewaySoftwareApi.UpdateWebHookDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.UpdateWebHookDto);
    });
