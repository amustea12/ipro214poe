...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GatewaySoftwareApi.TemperatureSensorDto();
  });
  ...
  describe('TemperatureSensorDto', function() {
    it('should create an instance of TemperatureSensorDto', function() {
      // uncomment below and update the code to test TemperatureSensorDto
      //var instane = new GatewaySoftwareApi.TemperatureSensorDto();
      //expect(instance).to.be.a(GatewaySoftwareApi.TemperatureSensorDto);
    });
